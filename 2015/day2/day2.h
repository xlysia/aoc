...
namespace aoc2015{
    namespace day2{
        ...
        void run(){
            ...
            assert (solvedayp1("./2015/day2/day2sample")=="101");
            std::cout << solvedayp1("./2015/day2/day2") << std::endl;

            std::cout << "Part 2" << std::endl;
            assert (solvedayp2("./2015/day2/day2sample")=="48");
            std::cout << solvedayp2("./2015/day2/day2") << std::endl;
        }
