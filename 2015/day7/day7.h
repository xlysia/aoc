...
namespace aoc2015{
    namespace day7{
        ...
        void run(){
           ...
           // assert (solvedayp1("./2015/day7/day7sample")=="-3");
            std::cout << solvedayp1("./2015/day7/day7") << std::endl;

            std::cout << "Part 2" << std::endl;
            // assert (solvedayp2("./2015/day7/day7sample")=="-1");
             std::cout << solvedayp2("./2015/day7/day7") << std::endl;
        }
